...
def main_worker(rank, config):
    ...
    if (not config["distributed"]) or config["global_rank"] == 0:
        ...
        print("train data will be saved in {}".format(config["save_dir"]))
...
def main():
    ...
    # setting distributed configrations
    ...
    print("Start Training: \n %d GPU is available" % config["world_size"])
